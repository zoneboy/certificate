...
const Certificate: React.FC<CertificateProps> = ({ data }) => {
  return (
    ...
    >
      ...
      >
        {/* Top Right Green Corner Decoration */}
        <div 
        ...
        {/* Bottom Left Green Corner Decoration */}
        <div 
        ...
        <div className="z-10 w-full h-full flex flex-col px-16 pt-12 pb-8 relative">
          ...
          <div className="w-full flex justify-between items-end mt-auto px-8 relative">
            ...
            <div className="flex flex-col items-center w-64">
              <div className="h-16 w-48 flex items-end justify-center overflow-hidden">
                <SignatureHarold className="w-full h-auto text-black" />
              </div>
              <div className="w-full h-0.5 bg-black mb-2 -mt-1"></div>
            ...
            <div className="flex flex-col items-center w-64">
              <div className="h-16 w-48 flex items-end justify-center overflow-hidden">
                <SignatureCajetan className="w-full h-auto text-black" />
              </div>
              <div className="w-full h-0.5 bg-black mb-2 -mt-1"></div>
